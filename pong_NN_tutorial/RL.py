...
import numpy as np
import random
#deque is a q data structure to store memory
...
#learning rate
GAMMA = 0.99
#gradient update / train over time
INITIAL_EPSILON = 1.0
FINAL_EPSILON = 0.05
...
def createGraph():
    ...
    #tf.zeros creates an empty tensor with all elements set to zero with a shape
    ...
    #fourth layer is the (1st) fully connected layer
    W_fc4 = tf.Variable(tf.zeros([3136, 784]))
    b_fc4 = tf.Variable(tf.zeros([784]))

    #fifth layer is the (2nd) fully connected layer
