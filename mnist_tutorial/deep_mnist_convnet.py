...
# build a multilayer convolutional neural network
# to improve model's accuracy from 92% to 99.2%.
...
# convolve x_image with the weight tensor, add bias, apply ReLU and max pool.
...
# Readout Layer - add softmax layer
